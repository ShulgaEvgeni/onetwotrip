...
class Hotel  extends React.Component {
	...
	componentDidMount() {
		...
		setTimeout(this.props.loadwhitelabelOTT("https://static.onetwotrip.com/gadgets/vk-app/prod/vk_hotel_vk-app/", "5c6bfe336135562ac4c3893e", "whitelabelOTTHotel"), 1);
	}
					...
					<div className="header-main" style={{height: "70px"}}> 
						<div className="header-1"> 
							<div className="header-2"> 
								...
								<div style={{background: "hsla(0,0%,100%,.2)"}} className="header-menu-item" onClick={() => {this.goApp('hotel')}}><img src="../icon/hotels.svg" alt="hotels"/><p>Отели</p></div>
