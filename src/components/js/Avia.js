...
class Avia  extends React.Component {
	...
	componentDidMount() {
		...
		setTimeout(this.props.loadwhitelabelOTT("https://static.onetwotrip.com/gadgets/vk-app/prod/vk_avia_vk-app/", "5c6bfe146135562ac4c3893c", "whitelabelOTTavia"), 1);
	}
					...
					<div className="header-main" style={{height: "70px"}}> 
						<div className="header-1"> 
							<div className="header-2"> 
								...
								<div style={{background: "hsla(0,0%,100%,.2)"}} className="header-menu-item" onClick={() => {this.goApp('avia')}}><img src="../icon/avia.svg" alt="avia"/><p>Авиабилеты</p></div>
							</div>
							{btloginHead}
						</div>  
					</div>
